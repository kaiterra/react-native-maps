...
const propTypes = {
  ...
  /**
   * (Optional) Tell the tile view whether to draw grid line of tiles
   *
   * @platform ios
   */

  shouldDrawGridLine: PropTypes.bool,

    /**
   * (Optional) Tell the tile view whether the tile is always hidden for some tile loading events or some other purposes.
   *
   * @platform ios
   */
  backgroundTile: PropTypes.bool,
 /**
   *
